...
var yt_videos = ['tnIK4MVGjWU','SsYhXFq2Txs','JJWuZG5y4MI','vnQzTMbHUYk','5PyXWG1VzRU'];
...
jQuery(document).ready(function () {
  ...
  jQuery('#yt_container').html('<div id="yt_videosurround"><div id="yt_embededvideo"><iframe width="'+ yt_width +'" height="'+ yt_height +'" src="https://www.youtube.com/embed/'+ yt_videos[0] +'" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div></div><ul id="mycarousel" class="jcarousel-skin-tango">'+yt_html+'</ul>');
  var embeded_cssObj = {
    'width' : yt_width,
  'height' : yt_height
  }
...
function change_embeded(video_id){
  jQuery('#yt_embededvideo').html('<iframe width="'+ yt_width +'" height="'+ yt_height +'" src="https://www.youtube.com/embed/'+ video_id +'" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>')
}
